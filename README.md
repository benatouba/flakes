...
<h2 align="center">benatouba's NixOS Config</h2>
...
*安装主题任意选择一个即可：具体见[这里](https://github.com/benatouba/flakes/blob/main/hosts/laptop/wayland/home.nix#L11-L13)*
...
### 如何安装？
最小安装(包含wm,没有tmpfs as root)，前往[此处](https://github.com/benatouba/flakes/tree/minimal)
...
```bash
nix-shell -p git
git clone  https://github.com/benatouba/flakes.git --branch=minimal /mnt/etc/nixos/Flakes
...
9. Install bspwm or hyprland see [here](https://github.com/benatouba/flakes/blob/44b2d4cf868dbce743e714e47dbf4975c13fe958/hosts/default.nix#L17-L18) and [here](https://github.com/benatouba/flakes/blob/44b2d4cf868dbce743e714e47dbf4975c13fe958/hosts/default.nix#L31-L32)
