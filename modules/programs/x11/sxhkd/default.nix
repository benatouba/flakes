  ...
  config = lib.mkIf (config.xsession.enable) {
    services.sxhkd = {
      ...
      keybindings = {
        ...
        "alt + shift +d" = "kitty  --class='danmufloat' --hold sh -c 'cd /home/ben/Codelearning/go/src/bilibili_live_tui/  && export TERM=xterm-256color && go run main.go -c config.toml'";
        "alt + shift +x" = " ";
