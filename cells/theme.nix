...
let
  ...
  themes = {
    catppuccin-mocha = {
      ...
      accent = "mauve";
      borderColor = "ffc0cb";
      gtk = { theme = "Catppuccin-Frappe-Pink"; package = "catppuccin-frappe-gtk"; };
      icons = { name = "Papirus-Dark"; };
      cursor = { name = "Catppuccin-Frappe-Dark"; };
      ...
      font = { sans = "Noto Sans"; mono = "JetBrainsMono Nerd Font"; size = 11; monoSize = 15; };
      cava = {
    ...
    catppuccin-latte = {
      ...
      accent = "mauve";
      borderColor = "C4ACEB";
      gtk = { theme = "Catppuccin-Latte-Green"; package = "catppuccin-latte-gtk"; };
      icons = { name = "Papirus-Light"; };
      cursor = { name = "Catppuccin-Latte-Dark"; };
...
in
{
  config.my.theme = themes.${themeName} or (throw "Unknown theme: ${themeName}");
}
